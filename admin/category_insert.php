                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea class="span6 " rows="3" name="description"></textarea>
                                </div>
                            </div>
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST")
                            {
                                ...
                                { 
                                    ...
                                    if($cname!=''&& $cdesc!='')
                                    {
									    ...
									    $sql = "insert into category(c_name,c_description)
                                        values('".$cname."','".$cdesc."')";
                                        
                                        $result=mysqli_query($conn,$sql);
                                        if($result)
                                        {
                                            echo "<meta http-equiv='refresh' content='0;category_view.php'>";
                                        }
                                    }
                                    else
                                    {
